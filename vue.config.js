...
const localUrl0 = "http://172.18.102.14:8283";
const localUrl1 = "http://172.18.102.15:8090";
const userUrl = "https://report.shaanxicredit.com";
...
module.exports = {
  ...
  // 那么将这个值改为 '/my-app/'
  // publicPath: isProd ? "/industCommGraph" : "./",
  publicPath: "/industCommGraph",
  // 构建好的文件输出到哪里
  outputDir: "dist",
